    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in space-y-8">
            ...
            <TajwidCard title="Huruf Hijaiyah">
                ...
                <div dir="rtl" className="font-amiri-quran text-3xl tracking-wider text-center bg-primary-50 dark:bg-gray-700 p-4 rounded-md">
            ...
            <TajwidCard title="Hukum Nun Sukun (نْ) dan Tanwin (ـًـــٍـــٌ)">
                ...
                <div className="mt-4 space-y-4">
                    <div>
                        ...
                        <p>Dibaca jelas tanpa dengung. Terjadi jika Nun Sukun/Tanwin bertemu dengan salah satu dari 6 huruf halq (tenggorokan): <span dir="rtl" className="font-amiri-quran font-bold">ء هـ ع ح غ خ</span>.</p>
                        <p className="mt-1 p-2 bg-gray-100 dark:bg-gray-700 rounded-md font-amiri-quran text-xl leading-relaxed" dir="rtl">Contoh: مِنْ خَيْرٍ</p>
                    </div>
                    <div>
                        ...
                        <ul className="list-disc list-inside ml-4">
                            <li><strong>Idgham Bi Ghunnah (dengan dengung):</strong> bertemu huruf <span dir="rtl" className="font-amiri-quran font-bold">ي ن م و</span>. Contoh: <span dir="rtl" className="font-amiri-quran p-1 rounded bg-gray-100 dark:bg-gray-700">مَنْ يَعْمَلْ</span></li>
                            <li><strong>Idgham Bila Ghunnah (tanpa dengung):</strong> bertemu huruf <span dir="rtl" className="font-amiri-quran font-bold">ل ر</span>. Contoh: <span dir="rtl" className="font-amiri-quran p-1 rounded bg-gray-100 dark:bg-gray-700">مِنْ رَبِّهِمْ</span></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-semibold text-lg text-gray-800 dark:text-gray-200">3. Iqlab (إقلاب) - Mengganti</h4>
                        <p>Mengganti suara Nun Sukun/Tanwin menjadi suara Mim (م) disertai dengung. Terjadi jika bertemu huruf <span dir="rtl" className="font-amiri-quran font-bold">ب</span>.</p>
                        <p className="mt-1 p-2 bg-gray-100 dark:bg-gray-700 rounded-md font-amiri-quran text-xl leading-relaxed" dir="rtl">Contoh: مِنْ بَعْدِ</p>
                    </div>
                    <div>
                        ...
                        <p>Menyamarkan suara Nun Sukun/Tanwin dengan dengung. Terjadi jika bertemu dengan 15 huruf sisa selain huruf-huruf di atas.</p>
                         <p className="mt-1 p-2 bg-gray-100 dark:bg-gray-700 rounded-md font-amiri-quran text-xl leading-relaxed" dir="rtl">Contoh: إِنْسَانٌ</p>
                    </div>
                </div>
            </TajwidCard>
        </div>
